...
export const POSCart = ({
  ...
  discountBill, setDiscountBill, updateQty, updateNotes, removeItem, onClear, onPay,
}: Props) => {
    ...
    <div className="flex flex-col h-full bg-card border-l">
      ...
      <div className="border-t p-3 space-y-2 bg-muted/30">
        ...
        <div className="flex justify-between items-center pt-2 border-t">
          ...
          <span className="text-2xl font-bold text-primary">{fmt(totals.total)}</span>
        </div>
        <Button className="w-full h-12 text-lg" disabled={items.length === 0} onClick={onPay}>
          BAYAR
        </Button>
      </div>
    </div>
